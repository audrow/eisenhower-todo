...
A todo list that uses the [Eisenhower method](https://www.theenterpriseworld.com/eisenhower-box/0), which separates your tasks into four categories that can be handled differently.

![Eisenhower box example](./resources/imgs/Eisenhower-Box.png)
